...
export default function EditPost() {
    ...
    return (
      <AdminLayout>
        <div className="flex justify-center items-center h-64">
          <div className="text-gray-600">Memuat data lowongan...</div>
        </div>
      </AdminLayout>
    );
  }
  ...
  return (
    <AdminLayout>
      <div>
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900">Edit Lowongan</h2>
          <p className="text-gray-600 mt-2">Edit lowongan kerja yang sudah ada</p>
        </div>
